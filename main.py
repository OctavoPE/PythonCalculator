...
bt: dict = {'size': (7, 2), 'font': ('Franklin Gothic Book', 24), 'button_color': ("black", "#899afa")}
bo: dict = {'size': (15, 2), 'font': ('Franklin Gothic Book', 24), 'button_color': ("black", "#3752ed"), 'focus': True}

# Window and Layout
layout = [
    [sg.Text('Calculator', size=(50, 1), justification='right', background_color="#272533", text_color='white', font=('Franklin Gothic Book', 14, 'bold'))],
    ...
    [sg.Button('C', **bt), sg.Button('CE', **bt), sg.Button('%', **bt), sg.Button("/", **bt)], # * single star will unpack a tuple, but a ** unpacks a dictionary.
...
window = sg.Window('Calculator', layout=layout, background_color="#272533", size=(580, 660), return_keyboard_events=True)
